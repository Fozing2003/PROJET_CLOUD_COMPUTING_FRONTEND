...
const teamMembers = [
  {
    name: "MADEU BERTRAND",
    role: "Développeur Frontend/Backend, Spécialiste Cloud",
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <main className="max-w-screen-xl mx-auto px-6 sm:px-12 py-16 w-full text-gray-800">
        ...
        >
          Nous sommes un groupe d’étudiants passionnés en Master, spécialisés en
          Réseaux et Services Distribués. Notre équipe a collaboré sur ce
          projet dans le cadre du cours de Cloud, afin d’explorer en pratique
          le deploiement et la supervision des applications.
        </motion.p>
        <motion.p
          className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-6"
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          Chaque membre a contribué à différents aspects du projet,
          notamment le développement frontend, les microservices backend,
          la conception d’API et leur intégration.
        </motion.p>
        <motion.p
        ...
        >
          Ensemble, nous avons construit une application évolutive et modulaire
          pour démontrer la puissance des systèmes distribués modernes.
        </motion.p>
